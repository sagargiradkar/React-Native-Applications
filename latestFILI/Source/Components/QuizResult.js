...
import { API_BASE_URL ,QUIZZEZ_SUBMIT_ENDPOINT,UPDATE_AUTO_QUIZ_POST_ENDPOINT,TOPIC_ENDPOINT} from "../Constant/ConstantApi";

const API_URL = `${API_BASE_URL}:${QUIZZEZ_SUBMIT_ENDPOINT}`;
const USER_API_URL = `${API_BASE_URL}:${UPDATE_AUTO_QUIZ_POST_ENDPOINT}`;
const TOPIC_API_URL = `${API_BASE_URL}:${TOPIC_ENDPOINT}`;
