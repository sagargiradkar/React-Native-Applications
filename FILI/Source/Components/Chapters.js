...
const ChaptersPage = (props) => {
  ...
  const fetchModulesFromBackend = async () => {
    ...
    const url = `http://192.168.143.131:8085/api/v1/usersModulesChapters/user/chapter/${ID}`;
  ...
  const onNextOrPrevious = async (isNext) => {
    ...
    const apiUrl = isNext
      ? `http://192.168.143.131:8085/api/v1/usersModulesChapters/user/nextChapter/${ID}`
      : `http://192.168.143.131:8085/api/v1/usersModulesChapters/user/previousChapter/${ID}`;
